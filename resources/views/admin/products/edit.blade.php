                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <select class="form-control @error('gender') is-invalid @enderror"
                                                    ...
                                                    <option value="man"
                                                        {{ old('gender', $product->gender) == 'man' ? 'selected' : '' }}>
                                                        {{ __('messages.Man') }}</option>
                                                    <option value="woman"
                                                        {{ old('gender', $product->gender) == 'woman' ? 'selected' : '' }}>
                                                        {{ __('messages.Woman') }}</option>
                                                    <option value="both"
                                                        {{ old('gender', $product->gender) == 'both' ? 'selected' : '' }}>
                                                        {{ __('messages.Both') }}</option>
                                                </select>
                                            </div>
                                                ...
                                                @foreach ($product->variations as $index => $variation)
                                                    <div class="variation-item border rounded p-3 mb-3">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label class="form-label">{{ __('messages.Color') }}
                                                                        <span class="text-danger">*</span></label>
                                                                    <select class="form-control"
                                                                        name="variations[{{ $index }}][color_id]"
                                                                        required>
                                                                        <option value="">
                                                                            {{ __('messages.Select_Color') }}</option>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label class="form-label">{{ __('messages.Size') }}
                                                                        <span class="text-danger">*</span></label>
                                                                    <select class="form-control"
                                                                        name="variations[{{ $index }}][size_id]"
                                                                        required>
                                                                        <option value="">
                                                                            {{ __('messages.Select_Size') }}</option>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mb-3">
                                                                    <label
                                                                        class="form-label">{{ __('messages.Price_Adjustment') }}</label>
                                                                    <input type="number" step="0.01"
                                                                        class="form-control"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control"
                                                                        ...
                                                                        <option value="1"
                                                                            {{ $variation->status == 1 ? 'selected' : '' }}>
                                                                            {{ __('messages.Active') }}</option>
                                                                        <option value="2"
                                                                            {{ $variation->status == 2 ? 'selected' : '' }}>
                                                ...
                                                <select class="form-control @error('celebrity_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($celebrities as $celebrity)
                                                        <option value="{{ $celebrity->id }}"
                                                            {{ old('celebrity_id', $product->celebrity_id) == $celebrity->id ? 'selected' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control"
                            name="variations[INDEX][price_adjustment]" value="0">
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="mb-3">
