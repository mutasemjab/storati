        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">{{ __('messages.Shops') }}</h3>
                    @can('shop-add')
                        <a href="{{ route('shops.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> {{ __('messages.Add_Shop') }}
                        </a>
                    @endcan
                </div>
                            ...
                            <tbody>
                                @forelse($shops as $shop)
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{{ $shop->name_ar }}</strong>
                                        </td>
                                        <td>
                                            <span class="badge bg-info">
                                                {{ $shop->products_count ?? 0 }} {{ __('messages.Products') }}
                                            </span>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">{{ __('messages.No_Shops_Found') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
