        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(route('shops.index')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('shops.*') ? 'active' : ''); ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('celebrities.index')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('celebrities.*') ? 'active' : ''); ?>">
                                <i class="fas fa-handshake nav-icon"></i>
                                <p><?php echo e(__('messages.Celebrities')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('banner-celebrities.index')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('banner-celebrities.*') ? 'active' : ''); ?>">
                                <i class="fas fa-handshake nav-icon"></i>
                                <p><?php echo e(__('messages.banner_celebrities')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                 ...
                 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['celebrity-stories-table', 'celebrity-stories-add', 'celebrity-stories-edit', 'celebrity-stories-delete'])): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('celebrity-stories.index')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('celebrity-stories.index') ? 'active' : ''); ?>">
                                        <i class="fas fa-handshake nav-icon"></i>
                                        <p><?php echo e(__('messages.Celebrity Stories')); ?></p>
                                    </a>
                                </li>
                 <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\storati\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>